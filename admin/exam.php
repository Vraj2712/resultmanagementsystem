...
?>
    ...
    <div class="modal fade" id="delete-exam<?php echo $exam_id; ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-md" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Delete exam <?php echo $name; ?></h5>
                ...
                <div class="modal-body">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="modal-footer" style="margin-bottom: -10px;">
                            ...
                            <input type="submit" class="btn btn-outline-danger" value="Delete exam" id="submit" name="delete_exam">
                        </div>
                    </form>
                </div>
            </div>
...
if(isset($_POST['delete_exam'])){
    ...
    try{
        ...
        echo "<p class='alert alert-success alert-dismissible fade show' role='alert'>
                    <i class='fas fa-check-circle'></i> Exam data deleted successfully.
                  <button type=\"button\" class=\"close\" data-dismiss=\"alert\" aria-label=\"Close\">
                             <span aria-hidden=\"true\">×</span>
                  </button>
                   <meta http-equiv='refresh' content='3; exam'>
