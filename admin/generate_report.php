    ...
    if ($rowcount > 0) {
        ...
        class PDF extends TCPDF
        {
            ...
            public function Header()
            {
                ...
                $this->Image($imageFile, 30, 2, 20, '', 'JPG', '', 'T', false, 300, '', false, false, 0, false, false, false);
                $this->Ln(2);
                $this->SetFont('helvetica', 'B', 20);
                $this->cell(195, 2, "$school_name", 0, 1, "C");
              ...
              <div class='row'>
                 <div class='col-md-3'>
                  ...
                  <p><strong>Class:</strong> $class &nbsp; <strong>Section:</strong> $new_section</p>
                   <p><strong>Exam:</strong> $new_exam </p>
...
// add a page
        ...
        $pdf->Cell(25, 4, '1st CA ', 1, 0, 'L', 1);
        $pdf->Cell(25, 4, '2nd CA ', 1, 0, 'L', 1);
        $pdf->Cell(25, 4, ' Exam ', 1, 0, 'L', 1);
...
//            $pdf->SetTextColor(14, 93,117);
        ...
        $pdf->SetTextColor(0, 0,0);
        $pdf->SetFont('times', 'N', '10');
        $pdf->Cell(20, 6, "$attendance %", 0, 0, 'L', 0); // % insted of times
...
//        $pdf->Ln(10);
        ...
        $pdf->SetTextColor(0, 0, 0);
        $pdf->SetFont('times', 'N', '10');
        $pdf->Cell(50, 5, "", 0, 0, "L"); //"(based on 50% and above)", in place of 3rd ""
